...
REM dotnet build "%~dp0..\..\SparkleShare.sln" /target:SparkleShare_Avalonia /t:Rebuild /p:Configuration=Release /p:Platform="Any CPU" -m
dotnet build SparkleShare\Avalonia\SparkleShare.Avalonia.csproj /t:Rebuild /p:Configuration=AvaloniaRelease /p:Platform="Any CPU" -m
...
if "%1"=="installer" (
	...
	dotnet restore
	REM dotnet tool install wix --create-manifest-if-needed
	REM dotnet build "%~dp0..\..\SparkleShare.sln" /target:SparkleShare_Avalonia_Installer /t:Build /p:Configuration=Release /p:Platform="Any CPU" -m
	dotnet build SparkleShare\Avalonia\Installer\SparkleShare.Avalonia.Installer.wixproj /p:Configuration=AvaloniaRelease /p:Platform="Any CPU" -m
