...
dotnet build "%~dp0..\..\..\..\SparkleShare.sln" /target:SparkleShare_Avalonia:Rebuild /p:Configuration=ReleaseAvalonia /p:Platform="x64" -m
...
if "%1"=="installer" (
	...
	dotnet restore
	REM dotnet tool install wix --create-manifest-if-needed
	dotnet build "%~dp0..\..\..\..\SparkleShare.sln" /target:SparkleShare_Avalonia_Installer:Rebuild /p:Configuration=ReleaseAvalonia /p:Platform="x64" -m
